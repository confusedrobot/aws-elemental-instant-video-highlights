...
if __name__ == '__main__':
    # create main table
    create_table_main('nab2018-catfinder5002-main')
    # add_autoscaler('nab2018-catfinder5002-main')
    # check_autscaler('nab2018-catfinder5002-main')
    # create summary table
    create_table_summary('nab2018-catfinder5002-summary')
    # add_autoscaler('nab2018-catfinder5002-summary')
    # check_autscaler('nab2018-catfinder5002-summary')    
    # create list table
    create_table_list('nab2018-catfinder5002-list')
    # add_autoscaler('nab2018-catfinder5002-list')
    # check_autscaler('nab2018-catfinder5002-list')        