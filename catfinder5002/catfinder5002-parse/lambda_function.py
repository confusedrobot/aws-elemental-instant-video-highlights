...
def lambda_handler(event, context):
    ...
    # job_name = filename_base
    # job_uri = "https://s3.amazonaws.com/" + S3_BUCKET + "/audio/" + filename_base + ".wav"
    ...
    # print('transcribe status: {}'.format(status['TranscriptionJob']['TranscriptionJobStatus']))
...
if __name__ == '__main__':
    ...
    os.environ['CHANNEL_NAME'] =  'nab2018-catfinder5002'
    os.environ['DYNAMO_MAIN'] = 'nab2018-catfinder5002-main'    
    os.environ['DYNAMO_SUMMARY'] = 'nab2018-catfinder5002-summary'
    # os.environ['DYNAMO_LIST'] = 'reinvent-list'
    this_event = {
        "Records": [
            {
            "eventVersion": "2.0",
            ...
            "s3": {
                ...
                "key": "live/stream_1.m3u8",
                "size": 1024
                },
                "bucket": {
                "arn": "arn:aws:s3:::ces2018-demo",
                "name": "sourcebucket",
                "ownerIdentity": {
                    "principalId": "EXAMPLE"
                }
    ...
    ## lambda-uploader --variables '{"HLS_URL": "live/stream.m3u8","HLS_URL_PLAYLIST": "live/stream_1.m3u8",  "S3_BUCKET" : "ces2018-demo", "REKOG_LABEL" : "Cat" }'
    print('UPLOAD Command: \tlambda-uploader --variables \'{"CHANNEL_NAME": "' + CHANNEL_NAME + '","DYNAMO_MAIN": "' + DYNAMO_MAIN + '","DYNAMO_SUMMARY": "' + DYNAMO_SUMMARY + '" }\'')
