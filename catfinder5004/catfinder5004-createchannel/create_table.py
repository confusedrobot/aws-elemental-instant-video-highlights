...
if __name__ == '__main__':
    # create main table
    create_table_main('catfinder5004-main')
    # add_autoscaler('catfinder5004-main')
    # check_autscaler('catfinder5004-main')
    # create summary table
    create_table_summary('catfinder5004-summary')
    # add_autoscaler('catfinder5004-summary')
    # check_autscaler('catfinder5004-summary')    
    # create list table
    create_table_list('catfinder5004-list')
    # add_autoscaler('catfinder5004-list')
    # check_autscaler('catfinder5004-list')        